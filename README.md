...
[![](https://travis-ci.org/datoma/mailserver.svg?branch=master)](https://travis-ci.org/datoma/mailserver) [![](https://images.microbadger.com/badges/version/datoma/mailserver:1.1-latest.svg)](https://microbadger.com/images/datoma/mailserver:1.1-latest)

### Docker image

[![](https://images.microbadger.com/badges/image/datoma/mailserver:1.1-latest.svg)](https://microbadger.com/images/datoma/mailserver:1.1-latest) [![](https://img.shields.io/docker/automated/datoma/mailserver.svg)](https://hub.docker.com/r/datoma/mailserver/builds/) [![](https://img.shields.io/docker/pulls/datoma/mailserver.svg)](https://hub.docker.com/r/datoma/mailserver/) [![](https://img.shields.io/docker/stars/datoma/mailserver.svg)](https://hub.docker.com/r/datoma/mailserver/)
...
&& curl https://raw.githubusercontent.com/datoma/mailserver/master/docker-compose.sample.yml -o docker-compose.yml \
&& curl https://raw.githubusercontent.com/datoma/mailserver/master/sample.env -o .env \
&& curl https://raw.githubusercontent.com/datoma/mailserver/master/traefik.sample.toml -o traefik/traefik.toml \
...
* Docker image : https://github.com/datoma/postfixadmin
* How to setup : [Postfixadmin initial configuration] Postfixadmin-initial-configuration.md
...
Create your `user.conf` file under `/mnt/docker/mail/clamav-unofficial-sigs` directory to configure clamav-unofficial-sigs updater. This file override the default configuration specified in [os.conf](https://github.com/datoma/mailserver/blob/master/rootfs/etc/clamav/unofficial-sigs/os.conf) and [master.conf](https://github.com/datoma/mailserver/blob/master/rootfs/etc/clamav/unofficial-sigs/master.conf). Don't forget, once you have completed the configuration of this file, set the value of `user_configuration_complete` to `yes` otherwise the script will not be able to execute.
...
Migrating-from-1.0-stable-to-1.1-stable.md
